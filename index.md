...
| Lesson | Overview                                                                                                                                                         | 
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [Data Organization in Spreadsheets for Health Scientists](https://UW-Madison-DataScience.github.io/spreadsheet-hsdc-lesson/)       | Learn how to organize tabular data, handle date formatting, carry out quality control and quality assurance and export data to use with downstream applications. | 
| [Data Cleaning with OpenRefine for Health Scientists](https://UW-Madison-DataScience.github.io/OpenRefine-hsdc-lesson/)       | Explore, summarize, and clean tabular data reproducibly.                                                                                                         | 
| [Data Analysis and Visualization in R for Health Scientists](https://UW-Madison-DataScience.github.io/R-hsdc-lesson/)       | Import data into R, calculate summary statistics, and create publication-quality graphics.                                                                       | 
| [Data Management with SQL for Health Scientists	](https://UW-Madison-DataScience.github.io/sql-hsdc-lesson/)       | Structure data for database import. Query data within a relational database.                                                                                     | 
